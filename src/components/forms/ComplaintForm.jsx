  ...
  const handleSendMobileOtp = async () => {
    ...
    try {
      ...
      const req = {
        ...
        productName: formikUser.values.productName,
      };
                ...
                {/* <div className="bg-theme/10 py-10 relative flex justify-center rounded-md">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-600 text-sm font-medium mt-5">
                      {formikUser?.values.files ? (
                        "Files Selected"
                      ) : (
                        <div>
                          "Uplaod Supported Documents"
                ...
                <div className="bg-theme/5 border border-theme/20 py-8 relative flex justify-center rounded-md">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      const existingFiles = formikUser.values.files || [];
                      const totalFiles = [...existingFiles, ...newFiles].slice(0,5,); // HARD LIMIT
                      formikUser.setFieldValue("files", totalFiles);
                ...
                <div className="flex items-center gap-2 justify-end">
                  ...
                  <div className="flex justify-center mt-5">
                    <Button
                      type="submit"
                      btnName={
                        formikUser.isSubmitting ? "Submitting" : "Submit"
                      }
                      disabled={
                        !isMobileVerified ||
                        !isEmailVerified ||
              ...
              {statusData ? (
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 printable-content">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-6 text-sm">
                    ...
                    <div>
                      <p className="text-gray-400 text-xs">Selected Product</p>
                      <p className="font-medium text-gray-800">
                        {statusData?.productName == "PU"
                          ? "PAISA UDHAR"
                          : statusData?.productName == "EW"
                            ? "EARLYWAGES"
                            : statusData?.productName == "RF"
                              ? "REFYNE"
                              : statusData?.productName == "IP"
                                ? "INSTA PAISA"
                                : "N/A"}
                      </p>
                    </div>
